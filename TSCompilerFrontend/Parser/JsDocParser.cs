...
namespace TSCompilerFrontend.Parser
{
    public class JsDocParser
    {
        ...
        public static (JsDocTypeExpression res, List<Diagnostic> diagnostics) ParseJsDocTypeExpressionForTests(
        ...
        public JsDoc ParseJsDocCommentWorker(int? start = null, int? length = null)
        {
            ...
            void SkipWhitespace()
            {
                while (Token() == SyntaxKind.WhitespaceTrivia || Token() == SyntaxKind.NewLineTrivia) NextJsDocToken();
            }
            ...
            JsDocParameterTag ParseParamTag(AtToken atToken, Identifier tagName)
            {
                ...
                if ((OpenBracketToken)ParseOptionalToken<OpenBracketToken>(SyntaxKind.OpenBracketToken) != null)
                {
                    ...
                    isBracketed = true;
                    if ((EqualsToken)ParseOptionalToken<EqualsToken>(SyntaxKind.EqualsToken) != null) ParseExpression();
        ...
        private void ParseErrorAtPosition(int start, int length, DiagnosticMessage message, object arg0 = null)
        {
