...
namespace TSCompilerFrontend.Parser
{
    public class Parser
    {
        ...
        public Scanner Scanner = new Scanner(ScriptTarget.Latest, /*skipTrivia*/ true, LanguageVariant.Standard, null);
        ...
        public SourceFile ParseSourceFile(string fileName, string sourceText,
            ScriptTarget languageVersion, /*IncrementalParser.SyntaxCursor*/object syntaxCursor, bool setParentNodes,
        ...
        public void InitializeState(string _sourceText, ScriptTarget languageVersion, /*IncrementalParser.SyntaxCursor*/
        ...
        public SourceFile ParseSourceFileWorker(string fileName, ScriptTarget languageVersion, bool setParentNodes,
            ScriptKind scriptKind)
        {
        ...
        public Node ParseExpectedToken<T>(SyntaxKind t, bool reportAtCurrentPosition,
        ...
        public Node CreateMissingNode<T>(SyntaxKind kind, bool reportAtCurrentPosition,
        ...
        public Identifier CreateIdentifier(bool isIdentifier, DiagnosticMessage diagnosticMessage = null)
        {
            ...
            return (Identifier)CreateMissingNode<Identifier>(SyntaxKind.Identifier, /*reportAtCurrentPosition*/ false,
        ...
        public bool NextTokenCanFollowModifier()
        {
            ...
            {
                NextToken();
                if (Token() == SyntaxKind.DefaultKeyword) return LookAhead(NextTokenIsClassOrFunctionOrAsync);
        ...
        public NodeArray<T> ParseBracketedList<T>(ParsingContext kind, Func<T> parseElement, SyntaxKind open,
        ...
        public Identifier ParseRightSideOfDot(bool allowIdentifierNames)
        {
            if (Scanner.HasPrecedingLineBreak() && TokenIsIdentifierOrKeyword(Token()))
            {
                ...
                if (matchesPattern)
                    ...
                    return (Identifier)CreateMissingNode<Identifier>(SyntaxKind.Identifier, /*reportAtCurrentPosition*/
        ...
        public ILiteralExpression ParseLiteralNode(bool? internName = null)
        {
            ...
            if (t == SyntaxKind.RegularExpressionLiteral)
                return (ILiteralExpression)ParseLiteralLikeNode(new RegularExpressionLiteral(), internName == true);
        ...
        public /*TemplateMiddle | TemplateTail*/ ILiteralLikeNode ParseTemplateMiddleOrTemplateTail()
        {
            ...
            Debug.Assert(fragment.Kind == SyntaxKind.TemplateMiddle || fragment.Kind == SyntaxKind.TemplateTail,
        ...
        {
            return Token() == SyntaxKind.DotDotDotToken || IsIdentifierOrPattern() || IsModifierKind(Token()) ||
        ...
        public NodeArray<ParameterDeclaration> ParseParameterList(bool yieldContext, bool awaitContext,
        ...
        public /*CallSignatureDeclaration | ConstructSignatureDeclaration*/
        ...
        public bool IsUnambiguouslyIndexSignature()
        {
            ...
            //
            NextToken();
            if (Token() == SyntaxKind.DotDotDotToken || Token() == SyntaxKind.CloseBracketToken) return true;
        ...
        public IndexSignatureDeclaration ParseIndexSignatureDeclaration(int fullStart, NodeArray<Decorator> decorators,
        ...
        public /*PropertySignature | MethodSignature*/
        ...
        public ITypeElement ParseTypeMember()
        {
            ...
            if (IsIndexSignature()) return ParseIndexSignatureDeclaration(fullStart, /*decorators*/ null, modifiers);
        ...
        public ITypeNode ParseUnionOrIntersectionType(SyntaxKind /*.UnionType | SyntaxKind.IntersectionType*/ kind,
            Func<ITypeNode> parseConstituentType, SyntaxKind /*.BarToken | SyntaxKind.AmpersandToken*/ @operator)
        {
        ...
        public ITypeNode ParseTypeWorker()
        {
            ...
            if (Token() == SyntaxKind.NewKeyword) return ParseFunctionOrConstructorType(SyntaxKind.ConstructorType);
        ...
        public IExpression ParseExpression()
        {
            ...
            while ((operatorToken = ( /*BinaryOperator*/
                   ...
                   null) expr = MakeBinaryExpression(expr, operatorToken, ParseAssignmentExpressionOrHigher());
        ...
        public ArrowFunction ParseSimpleArrowFunctionExpression(Identifier identifier,
            NodeArray<Modifier> asyncModifier = null)
        {
            ...
            {
                node = new ArrowFunction
                    { Pos = identifier.Pos }; // (ArrowFunction)createNode(SyntaxKind.ArrowFunction, identifier.pos);
            }
            ...
            node.EqualsGreaterThanToken = (EqualsGreaterThanToken)ParseExpectedToken<EqualsGreaterThanToken>(
                SyntaxKind.EqualsGreaterThanToken, /*reportAtCurrentPosition*/ false, Diagnostics._0_expected, "=>");
        ...
        public ArrowFunction TryParseParenthesizedArrowFunctionExpression()
        {
            ...
            arrowFunction.EqualsGreaterThanToken = (EqualsGreaterThanToken)ParseExpectedToken<EqualsGreaterThanToken>(
                SyntaxKind.EqualsGreaterThanToken, /*reportAtCurrentPosition*/false, Diagnostics._0_expected, "=>");
        ...
        {
            if (Token() == SyntaxKind.OpenParenToken || Token() == SyntaxKind.LessThanToken ||
                Token() == SyntaxKind.AsyncKeyword) return LookAhead(IsParenthesizedArrowFunctionExpressionWorker);
            if (Token() == SyntaxKind.EqualsGreaterThanToken)
        ...
        public Tristate IsParenthesizedArrowFunctionExpressionWorker()
        {
            if (Token() == SyntaxKind.AsyncKeyword)
            {
                ...
                if (Token() != SyntaxKind.OpenParenToken && Token() != SyntaxKind.LessThanToken) return Tristate.False;
            }
        ...
        public /*Block | Expression*/ IBlockOrExpression ParseArrowFunctionExpressionBody(bool isAsync)
        {
            if (Token() == SyntaxKind.OpenBraceToken)
                return ParseFunctionBlock( /*allowYield*/false, /*allowAwait*/ isAsync, /*ignoreMissingOpenBrace*/
                    false);
            if (Token() != SyntaxKind.SemicolonToken &&
                Token() != SyntaxKind.FunctionKeyword &&
                Token() != SyntaxKind.ClassKeyword &&
        ...
        public IExpression ParseBinaryExpressionRest(int precedence, IExpression leftOperand)
        {
            while (true)
            {
                ...
                {
                    leftOperand = MakeBinaryExpression(leftOperand, ParseTokenNode< /*BinaryOperator*/Token>(Token()),
        ...
        public BinaryExpression MakeBinaryExpression(IExpression left, /*BinaryOperator*/Token operatorToken,
            IExpression right)
        {
        ...
        public /*Increment*/ IExpression ParseIncrementExpression()
        {
            ...
            if (SourceFile.LanguageVariant == LanguageVariant.Jsx && Token() == SyntaxKind.LessThanToken &&
        ...
        public bool TagNamesAreEquivalent(IJsxTagNameExpression lhs, IJsxTagNameExpression rhs)
        {
            ...
            if (lhs.Kind == SyntaxKind.Identifier) return (lhs as Identifier).Text == (rhs as Identifier).Text;
        ...
        public /*JsxElement | JsxSelfClosingElement*/
                ...
                if (inExpressionContext && Token() == SyntaxKind.LessThanToken)
                {
                    ...
                    if (invalidElement != null)
                    {
                        ...
                        badNode.OperatorToken = ( /*BinaryOperator*/
                            Token)CreateMissingNode<Token>(SyntaxKind.CommaToken, /*reportAtCurrentPosition*/ false);
        ...
        public NodeArray<IJsxChild> ParseJsxChildren( /*LeftHandSide*/ IExpression openingTagName)
        {
            ...
            while (true)
            {
                ...
                if (Token() == SyntaxKind.EndOfFileToken)
                {
                    ...
                    ParseErrorAtPosition(openingTagName.Pos ?? 0, (openingTagName.End ?? 0) - (openingTagName.Pos ?? 0),
        ...
        public Expression ParseJsxOpeningOrSelfClosingElement(bool inExpressionContext)
        {
            ...
            if (Token() == SyntaxKind.GreaterThanToken)
            {
                ...
                var node = new JsxOpeningElement
                    { Pos = fullStart }; //(JsxOpeningElement)createNode(SyntaxKind.JsxOpeningElement, fullStart);
        ...
        public /*LeftHandSideExpression*/
            IMemberExpression ParseCallExpressionRest( /*LeftHandSideExpression*/ IMemberExpression expression)
        {
            while (true)
            {
        ...
        public IExpression ParseArgumentOrArrayLiteralElement()
        {
            return Token() == SyntaxKind.DotDotDotToken
                ? ParseSpreadElement()
                : Token() == SyntaxKind.CommaToken
                    ? new OmittedExpression { Pos = Scanner.GetStartPos() } /*createNode(SyntaxKind.OmittedExpression)*/
                    : ParseAssignmentExpressionOrHigher();
        }
        ...
        public IAccessorDeclaration TryParseAccessorDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public Block ParseFunctionBlock(bool allowYield, bool allowAwait, bool ignoreMissingOpenBrace,
        ...
        public Statement ParseForOrForInOrForOfStatement()
        {
            ...
            else
            {
                ...
                ParseExpected(SyntaxKind.SemicolonToken);
                if (Token() != SyntaxKind.CloseParenToken) forStatement.Incrementor = AllowInAnd(ParseExpression);
        ...
        public CatchClause ParseCatchClause()
        {
            ...
            if (ParseExpected(SyntaxKind.OpenParenToken)) result.VariableDeclaration = ParseVariableDeclaration();
        ...
        public Block ParseFunctionBlockOrSemicolon(bool isGenerator, bool isAsync,
            DiagnosticMessage diagnosticMessage = null)
        {
        ...
        public IArrayBindingElement ParseArrayBindingElement()
        {
            if (Token() == SyntaxKind.CommaToken)
                return new OmittedExpression
                    { Pos = Scanner.GetStartPos() }; //(OmittedExpression)createNode(SyntaxKind.OmittedExpression);
        ...
        public VariableStatement ParseVariableStatement(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public FunctionDeclaration ParseFunctionDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public ConstructorDeclaration ParseConstructorDeclaration(int pos, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public MethodDeclaration ParseMethodDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers, AsteriskToken asteriskToken, IPropertyName name, QuestionToken questionToken,
            DiagnosticMessage diagnosticMessage = null)
        {
        ...
        public ClassElement ParsePropertyDeclaration(int fullStart, NodeArray<Decorator> decorators,
        ...
        public IClassElement ParsePropertyOrMethodDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
            var asteriskToken = (AsteriskToken)ParseOptionalToken<AsteriskToken>(SyntaxKind.AsteriskToken);
            var name = ParsePropertyName();
            var questionToken = (QuestionToken)ParseOptionalToken<QuestionToken>(SyntaxKind.QuestionToken);
            if (asteriskToken != null || Token() == SyntaxKind.OpenParenToken || Token() == SyntaxKind.LessThanToken)
                return ParseMethodDeclaration(fullStart, decorators, modifiers, asteriskToken, name, questionToken,
                    Diagnostics.or_expected);
        ...
        public IAccessorDeclaration ParseAccessorDeclaration(SyntaxKind kind, int fullStart,
        ...
        public NodeArray<Modifier> ParseModifiers(bool? permitInvalidConstAsModifier = null)
        {
            ...
            while (true)
            {
                ...
                var modifier = FinishNode(new Modifier
                    { Kind = modifierKind, Pos = modifierStart }); //(Modifier)createNode(modifierKind, modifierStart)
                if (modifiers == null)
                {
        ...
        public IClassElement ParseClassElement()
        {
            ...
            if (decorators?.Any() == true || modifiers?.Any() == true)
            {
                var name = (Identifier)CreateMissingNode<Identifier>(SyntaxKind.Identifier, /*reportAtCurrentPosition*/
        ...
        public ClassDeclaration ParseClassDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        {
            if (IsHeritageClause()) return ParseList(TsTypes.ParsingContext.HeritageClauses, ParseHeritageClause);
        ...
        public InterfaceDeclaration ParseInterfaceDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public TypeAliasDeclaration ParseTypeAliasDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public EnumDeclaration ParseEnumDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
        ...
        public ModuleDeclaration ParseModuleOrNamespaceDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers, NodeFlags flags)
        {
            ...
            node.Body = ParseOptional(SyntaxKind.DotToken)
                ? ( /*NamespaceDeclaration*/Node)ParseModuleOrNamespaceDeclaration(GetNodePos(), /*decorators*/
        ...
        public ModuleDeclaration ParseAmbientExternalModuleDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
            var node = new ModuleDeclaration { Pos = fullStart };
        ...
        public ModuleDeclaration ParseModuleDeclaration(int fullStart, NodeArray<Decorator> decorators,
            NodeArray<Modifier> modifiers)
        {
            NodeFlags flags = 0;
            if (Token() == SyntaxKind.GlobalKeyword)
        ...
        public NamespaceExportDeclaration ParseNamespaceExportDeclaration(int fullStart,
            NodeArray<Decorator> decorators, NodeArray<Modifier> modifiers)
        {
        ...
        public /*ImportEqualsDeclaration | ImportDeclaration*/
            IStatement ParseImportDeclarationOrImportEqualsDeclaration(int fullStart, NodeArray<Decorator> decorators,
                NodeArray<Modifier> modifiers)
        {
        ...
        public ImportEqualsDeclaration ParseImportEqualsDeclaration(int fullStart, NodeArray<Decorator> decorators,
