    ...
    switch (node.Kind)
    {
      ...
      case SyntaxKind.TypeOperator:
        ...
        return VisitNode(cbNode,
          (node as ParenthesizedTypeNode)?.Type ?? (node as TypeOperatorNode)?.Type);
      ...
      case SyntaxKind.NamedExports:
        ...
        return visitNodes(cbNodes, (node as NamedExports)?.Elements);
      ...
      case SyntaxKind.JsxOpeningElement:
        return VisitNode(cbNode,
                 ...
                 (node as JsxOpeningElement)?.TagName) ??
               VisitNode(cbNode,
                 (node as JsxSelfClosingElement)?.Attributes ??
                 (node as JsxOpeningElement)?.Attributes);
