...
public interface IAccessorDeclaration : ISignatureDeclaration, IClassElement,
...
public class TypePredicate : TypePredicateBase
{
}
...
public class Identifier : PrimaryExpression, IEntityName, IPropertyName
{
  public Identifier()
  {
...
public class PropertyAssignment : ObjectLiteralElement, IObjectLiteralElementLike,
  IVariableLikeDeclaration
{
...
public class MethodSignature : Declaration, ISignatureDeclaration, ITypeElement,
...
public class MethodDeclaration : Declaration, IFunctionLikeDeclaration, IClassElement,
...
public class GetAccessorDeclaration : Declaration, IFunctionLikeDeclaration, IClassElement,
  IObjectLiteralElement,
...
public class SetAccessorDeclaration : Declaration, IFunctionLikeDeclaration, IClassElement,
  IObjectLiteralElement,
  IAccessorDeclaration
{
...
public class IndexSignatureDeclaration : Declaration, ISignatureDeclaration, IClassElement,
  ITypeElement
{
...
public class PropertyAccessExpression : Node, IMemberExpression, IDeclaration,
...
public class
  JsxAttributes : ObjectLiteralExpressionBase<ObjectLiteralElement> // JsxAttributeLike>
{
...
public class MissingDeclaration : Node, IDeclarationStatement, IClassElement,
  IObjectLiteralElement, ITypeElement
{
...
public class HeritageClause : Node
{
  ...
  public SyntaxKind
    Token { get; set; } //  SyntaxKind.ExtendsKeyword | SyntaxKind.ImplementsKeyword
...
public class Signature
{
  ...
  public TypePredicate TypePredicate { get; set; }
