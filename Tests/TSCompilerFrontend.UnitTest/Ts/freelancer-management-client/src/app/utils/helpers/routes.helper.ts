...
import { TabkeView } from "utils/base-components/list/base-lsit.interface";
...
export function getRoutesComponents(path: string, list: Type<TabkeView | IBaseLookupList<any>>, viewComponent?: Type<BaseView<any> | BaseSingleDetail<any>>, routeData?: RouteData): Routes {
